...
class AutoSuggestUser extends Component {
  constructor() {
    super();
  ...
  onSuggestionSelected = (event, { suggestionValue }) => { 
    const user = this.props.users.filter(user => user.lastname === suggestionValue);    
...
export default connect(mapStateToProps, mapDispatchToProps)(AutoSuggestUser);
